  ...
  return (
    <Routes>
      ...
      <Route element={<RootLayout />}>
        ...
        <Route path="/home" element={<ArtsHome />} />
        <Route path="/favorites" element={<Favorites />} />
        <Route path="/gallery" element={<Gallery />} />
        <Route path="/bin" element={<Bin />} />
        <Route path="/filtered-post" element={<FilteredPost />} />
      ...
      <Route element={<SettingsLayout />}>
        ...
        <Route
          path="/settings/account-violation"
          element={<AccountViolation />}
        />
        <Route
          path="/settings/terms-agreement"
